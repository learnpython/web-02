...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('chitatel_user_groups')
        ...
        m2m_table_name = db.shorten_name('chitatel_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'users.user'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table('chitatel_user')

        # Removing M2M table for field groups on 'User'
        db.delete_table(db.shorten_name('chitatel_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name('chitatel_user_user_permissions'))
    ...
    models = {
        ...
        u'users.user': {
            ...
            'feeds': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['feeds.Feed']"}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['feeds.Tag']"}),
